...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/SEU_USERNAME`: `git checkout -b feat/community/Niedja92`; `
5. feat/community/your_user_name`:
    > Exemplo: `git checkout -b feat/community/Niedja92`
